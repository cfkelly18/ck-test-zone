...
import (
	...
	ck47moduletypes "ck47/x/ck47/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport

	appparams "ck47/app/params"
	"ck47/docs"
)
...
func New(
	...
	*/
	...
	app.Ck47Keeper = *ck47modulekeeper.NewKeeper(
		appCodec,
		keys[ck47moduletypes.StoreKey],
		keys[ck47moduletypes.MemStoreKey],
		app.GetSubspace(ck47moduletypes.ModuleName),
	)
	ck47Module := ck47module.NewAppModule(appCodec, app.Ck47Keeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(ck47moduletypes.ModuleName)
